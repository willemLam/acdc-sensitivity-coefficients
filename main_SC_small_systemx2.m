...
%% Get grid YY
[Yac, YYLac, YLac, YTac, YYTac, I_bac, Ampacitiesac, y_lx, y_tx, Aac, linedata_ac]  = Ymatrix('linedata_AC_smallx2.txt',A_b,V_b,[]);
[Ydc, YYLdc, YLdc, YTdc, YYTdc, I_bdc, Ampacitiesdc, y_ihdc, y_idc, Adc, linedata_dc]  = Ymatrix('linedata_DC_smallx2.txt',Adc_b,Vdc_b,[]);


Ydc = Ydc(7:end,7:end)/2;
YYLdc = YYLdc(7:end,7:end)/2;
YYTdc = YYTdc(7:end,7:end)/2;
YY = blkdiag(Yac,Ydc);
Grid_para.G = real(YY);
Grid_para.B = imag(YY);
Grid_para.YY = YY;
...
S = [0;complex(0.4,0.2);complex(0,-0.4);complex(0.3,0.3);complex(-0.2,0.4);0;0;-0.5;0];
E = [complex(1);complex(0.98,0.1);0;0;0;complex(1);1;0;0];
...
%% Start
modes = {'P2';'V2';'Q3';'E7';'P8';'P4';'Q4';'P5';'Q5'}; %{'P2';'Q2';'Q3';'E4';'P5'};
for m=1:length(modes)
    ...
    switch mode
        case 'P2'
            S_star2 = [0;complex(0.4+ad,0.2);complex(0,-0.4);complex(0.3,0.3);complex(-0.2,0.4);0;0;-0.5;0];
            E_star2 = [complex(1);complex(0.98,0.1);0;0;0;complex(1);1;0;0];
        case 'Q2'
            S_star2 = [0;complex(0.4,0.2+ad);complex(0,-0.4);complex(0.3,0.3);complex(-0.2,0.4);0;0;-0.5;0];
            E_star2 = [complex(1);complex(0.98,0.1);0;0;0;complex(1);1;0;0];
        case 'V2'
            S_star2 = [0;complex(0.4,0.2);complex(0,-0.4);complex(0.3,0.3);complex(-0.2,0.4);0;0;-0.5;0];
            E_star2 = [complex(1);(1+ad)*complex(0.98,0.1);0;0;0;complex(1);1;0;0];
        case 'Q3'
            S_star2 = [0;complex(0.4,0.2);complex(0,-0.4+ad);complex(0.3,0.3);complex(-0.2,0.4);0;0;-0.5;0];
            E_star2 = [complex(1);complex(0.98,0.1);0;0;0;complex(1);1;0;0];
        case 'E7'
            S_star2 = [0;complex(0.4,0.2);complex(0,-0.4);complex(0.3,0.3);complex(-0.2,0.4);0;0;-0.5;0];
            E_star2 = [complex(1);complex(0.98,0.1);0;0;0;complex(1);1+ad;0;0];
        case 'P8'
            S_star2 = [0;complex(0.4,0.2);complex(0,-0.4);complex(0.3,0.3);complex(-0.2,0.4);0;0;-0.5+ad;0];
            E_star2 = [complex(1);complex(0.98,0.1);0;0;0;complex(1);1;0;0];
        case 'P4' 
            S_star2 = [0;complex(0.4,0.2);complex(0,-0.4);complex(0.3+ad,0.3);complex(-0.2,0.4);0;0;-0.5;0];
            E_star2 = [complex(1);complex(0.98,0.1);0;0;0;complex(1);1;0;0];
        case 'Q4' 
            S_star2 = [0;complex(0.4,0.2);complex(0,-0.4);complex(0.3,0.3+ad);complex(-0.2,0.4);0;0;-0.5;0];
            E_star2 = [complex(1);complex(0.98,0.1);0;0;0;complex(1);1;0;0];
        case 'P5'
            S_star2 = [0;complex(0.4,0.2);complex(0,-0.4);complex(0.3,0.3);complex(-0.2+ad,0.4);0;0;-0.5;0];
            E_star2 = [complex(1);complex(0.98,0.1);0;0;0;complex(1);1;0;0];
        case 'Q5'
            S_star2 = [0;complex(0.4,0.2);complex(0,-0.4);complex(0.3,0.3);complex(-0.2,0.4+ad);0;0;-0.5;0];
            E_star2 = [complex(1);complex(0.98,0.1);0;0;0;complex(1);1;0;0];
        otherwise
            disp('NOPE') 
    end
...
case 'Q2'
    ...
    c = (E_star -E_star2 )/imag(S_star(i)-S_star2(i));
...
data_real(m,:) = [sqrt(mean((real(r) - real(c)).^2)), max(abs(max((real(r) - real(c)))), abs(min((real(r) - real(c))))) ]
data_imag(m,:) = [sqrt(mean((imag(r) - imag(c)).^2)), max(abs(max((imag(r) - imag(c)))), abs(min((imag(r) - imag(c))))) ];
