...
if size(linedata,2) == 9
    ...
    linedata(:,6)=(linedata(:,5)./Yb).*line_lengths*0;
    linedata(:,7)=(linedata(:,5)./Yb).*line_lengths;
    linedata(:,8)=(linedata(:,5)./Yb).*line_lengths*0;
else
    line_lengths=linedata(:,9);
    linedata(:,3)=(linedata(:,3).*Yb).*line_lengths; %R
    linedata(:,4)=(linedata(:,4).*Yb).*line_lengths; %X
    linedata(:,5)=(linedata(:,5)./Yb).*line_lengths; %B_from
    linedata(:,6)=(linedata(:,6)./Yb).*line_lengths; %G_from
    linedata(:,7)=(linedata(:,7)./Yb).*line_lengths; %B_to
    linedata(:,8)=(linedata(:,8)./Yb).*line_lengths; %G_to
end
%----------------------------------------------------------------------------------------------%
