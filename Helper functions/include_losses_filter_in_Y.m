function [Yac, A, Zloss,Zfilter] = include_losses_filter_in_Y(Text,Grid_para,Filter_para,idx1,E_star,type)
...
%     Zloss = 0*Zloss + 1e-6;
    %% make Y augmented
    [Yac, YYL, YL, YT, YYT, ~, ~, ~, ~, A, linedata] = make_Y_augmented(Text,Grid_para,idx1,Zloss,Zfilter,type);
