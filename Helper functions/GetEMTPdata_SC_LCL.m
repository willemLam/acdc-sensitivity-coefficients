function [Nodal_V_mag,Nodal_V_angle, Nodal_I_mag, Nodal_I_angle, Flow_I_mag, Flow_I_angle, Idc_flow, Idc_inj, Vdc, n_timesteps, M_real, M_imag, Mabs,Nodal_P,Nodal_Q,Pdc_inj,M] = GetEMTPdata_SC_LCL(A_b,V_b,Adc_b, Vdc_b,repeat,ZIN,n_phases) 
