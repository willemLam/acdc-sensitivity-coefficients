function [YY_prime, YYL, YL, YT, YYT, Ib, Ampacities, y_ih, y_i, A, linedata]  = make_Y_prime(Text,Grid_para,idx1,Zloss)
    ...
    idx_to_change = sort([idx1.vscac_pq; idx1.vscac_vq]);
    ...
    for i = 1:length(idx_to_change)
        ...
        linedata_append(2) = idx_to_change(i);
